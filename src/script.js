...
const texture = loader.load('/mountain_texture.webp');
...
// Objects
const geometry = new THREE.PlaneBufferGeometry( 3, 3, 64, 64);//on creer le Plane Buffer
...
// Lights
const defaultcolor = '#458C5E';

const pointLight = new THREE.PointLight(defaultcolor, 2)
